...
def submitFunction(sim: simulador):
    ...
    a1 = cajaTextoEntradasA1.get(1.0, "END")
    a2 = cajaTextoEntradasA2.get(1.0, "END")
    a3 = cajaTextoEntradasA3.get(1.0, "END")
    a4 = cajaTextoEntradasA4.get(1.0, "END")
    sim.listcoefa = [a1, a2, a3, a4]
    sim.hasDeclaredCoefA = True
    b0 = cajaTextoEntradasB1.get(1.0, "END")
    b1 = cajaTextoEntradasB2.get(1.0, "END")
    b2 = cajaTextoEntradasB3.get(1.0, "END")
    b3 = cajaTextoEntradasB4.get(1.0, "END")
...
botonReset = tkinter.Button(ventana, text="Reset",
                            width=35, height=2, command=resetFunction).grid(row=10, column=0, columnspan=2)
botonPause = tkinter.Button(ventana, text="Pause",
                            width=35, height=2, command=pauseFunction).grid(row=10, column=0, columnspan=2)
